...
async function loadBaseContent() {
  ...
  try {
    ...
    baseContentCache = {
      ...
      experience: [], projects: [], education: [], certifications: [], art: [], skills: [], publications: [], courses: []
    };
    return baseContentCache;
  }
}
...
export async function importContentFromFile(file) {
  ...
  const requiredKeys = ['profile', 'experience', 'projects', 'education', 'certifications', 'art', 'skills'];
